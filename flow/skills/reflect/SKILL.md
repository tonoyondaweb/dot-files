...
- Substantive existing-skill edit (a new section, a new pattern table, more than ~10 lines): author directly or hand to the skill creation tool (such as `create-skill` or `skill-creator`) and run its draft / test / iterate loop.
