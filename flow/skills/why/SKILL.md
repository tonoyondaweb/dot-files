...
Before spawning investigators, list the available MCP tools and servers from the environment. Use the available-tools map when present. Otherwise inspect configured MCP servers or environment declarations.
