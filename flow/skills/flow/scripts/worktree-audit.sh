...
# Transcripts dir: Check AGENT_TRANSCRIPTS_DIR / FLOW_TRANSCRIPTS_DIR, fallback to ~/.cursor/projects/<slugified-repo-path>/agent-transcripts.
slug=$(printf '%s' "$main_wt" | sed 's#^/##; s#/#-#g')
transcripts="${AGENT_TRANSCRIPTS_DIR:-${FLOW_TRANSCRIPTS_DIR:-"$HOME/.cursor/projects/$slug/agent-transcripts"}}"
now=$(date +%s)
